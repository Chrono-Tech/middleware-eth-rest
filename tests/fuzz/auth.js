...
module.exports = () => {
  ...
  it('GET /events/:event without auth headers - error', async () => {
    ...
    const response = await request(`http://localhost:${config.rest.port}/events/11`, {
      method: 'GET',
      json: true
    }).catch(e=>e);
  ...
  it('GET /events/mint/assets without auth headers - error', async () => {
    ...
    const response = await request(`http://localhost:${config.rest.port}/events/mint/assets`, {
      method: 'GET',
      json: true
    }).catch(e=>e);
  ...
  it('GET /events/mint/managerListByToken without auth headers - error', async () => {
    ...
    const response = await request(`http://localhost:${config.rest.port}/events/mint/managerListByToken`, {
      method: 'GET',
      json: true
    }).catch(e=>e);
